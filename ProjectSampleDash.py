...
app.layout = html.Div(children=[
    ...
    html.Div([
        html.Div([
            html.H1(children="---BEST SELLING AND MOST PROFITABLE CATEGORY IN DB---", style={'textAlign': 'center'}),
        ...
        html.Div([
            html.H1(children="---BEST SELLING AND MOST PROFITABLE SUB-CATEGORY IN DB---", style={'textAlign': 'center'}),
        ...
        html.Div([
            html.H1(children="---TOP SELLING SUB-CATEGORY INI DB---", style={'textAlign': 'center'}),
    ...
    html.Div([
        html.H1(children="---MOST PROFITABLE CUSTOMER SEGMENT IN DB---", style={'textAlign': 'center'}),
    ...
    html.Div([
            html.H1(children="---MOST PREFERED SHIP MODE IN DB---", style={'textAlign': 'center'}),
        ...
        html.Div([
        html.H1(children="---MOST PROFITABLE REGION IN DB", style={'textAlign': 'center'}),
    ...
    html.Div([
            html.H1(children="HIGHEST SELLING CITIES IN DB", style={'textAlign': 'center'}),
